...
template<typename BT, u16 P>
           struct is_promotable<std::complex<FP<BT, P> >, std::complex<float> > : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };
template<typename BT, u16 P>
           struct is_promotable<std::complex<FP<BT, P> >, float>                : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };
template<typename BT, u16 P>
           struct is_promotable<std::complex<float>,  FP<BT, P> >               : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };

template<typename BT, u16 P>
           struct is_promotable<std::complex<FP<BT, P> >, std::complex<double> > : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };
template<typename BT, u16 P>
           struct is_promotable<std::complex<FP<BT, P> >, double>                : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };
template<typename BT, u16 P>
           struct is_promotable<std::complex<double>, FP<BT, P> >                : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };

#if defined(ARMA_USE_U128S128)
template<typename t> struct is_promotable<std::complex<t>, u128>    : public is_promotable_ok { typedef std::complex<t> result; };
template<typename t> struct is_promotable<std::complex<t>, s128>    : public is_promotable_ok { typedef std::complex<t> result; };
#endif
...
template<typename BT, u16 P>
                    struct is_promotable<FP<BT, P>,  float>  : public is_promotable_ok { typedef FP<BT, P> result;  };
template<typename BT, u16 P>
                    struct is_promotable<float,  FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result;  };
template<typename BT, u16 P>
                    struct is_promotable<FP<BT, P>,  double> : public is_promotable_ok { typedef FP<BT, P> result;  };
template<typename BT, u16 P>
                    struct is_promotable<double, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result;  };

template<> struct is_promotable<double, float > : public is_promotable_ok { typedef double result; };
#if defined(ARMA_USE_U128S128)
template<> struct is_promotable<double, s128  > : public is_promotable_ok { typedef double result; };
template<> struct is_promotable<double, u128  > : public is_promotable_ok { typedef double result; };
#endif
#if defined(ARMA_USE_U64S64)
...
#if defined(ARMA_USE_U128S128)
template<> struct is_promotable<float, s128  > : public is_promotable_ok { typedef float result; };
template<> struct is_promotable<float, u128  > : public is_promotable_ok { typedef float result; };
#endif
#if defined(ARMA_USE_U64S64)
...
#if defined(ARMA_USE_U128S128)
#if defined(ARMA_USE_U64S64)
template<> struct is_promotable<u128, u64> : public is_promotable_ok { typedef u128 result; };
#endif
template<> struct is_promotable<u128, u32> : public is_promotable_ok { typedef u128 result; };
template<> struct is_promotable<u128, u16> : public is_promotable_ok { typedef u128 result; };
template<> struct is_promotable<u128, u8 > : public is_promotable_ok { typedef u128 result; };
#endif
...
#if defined(ARMA_USE_U128S128)
template<> struct is_promotable<s128, u128> : public is_promotable_ok { typedef s128 result; };
#if defined(ARMA_USE_U64S64)
template<> struct is_promotable<s128, u64>  : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<s128, s64>  : public is_promotable_ok { typedef s128 result; };
#endif
template<> struct is_promotable<s128, u32>  : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<s128, s32>  : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<s128, s16>  : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<s128, u16>  : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<s128, s8 >  : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<s128, u8 >  : public is_promotable_ok { typedef s128 result; };
#endif
...
#if defined(ARMA_USE_U128S128)
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, s128> : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, u128> : public is_promotable_ok { typedef FP<BT, P> result; };
#endif
#if defined(ARMA_USE_U64S64)
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, s64> : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, u64> : public is_promotable_ok { typedef FP<BT, P> result; };
#endif
#if defined(ARMA_ALLOW_LONG)
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, slng_t> : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, ulng_t> : public is_promotable_ok { typedef FP<BT, P> result; };
#endif
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, s32   > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, u32   > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, s16   > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, u16   > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, s8    > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, u8    > : public is_promotable_ok { typedef FP<BT, P> result; };
...
template<typename BT, u16 P> struct is_promotable<std::complex<float>, std::complex<FP<BT, P> > >  : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };
template<typename BT, u16 P> struct is_promotable<float, std::complex<FP<BT, P> > >                : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, std::complex<float> >                 : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };

template<typename BT, u16 P> struct is_promotable<std::complex<double>, std::complex<FP<BT, P> > > : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };
template<typename BT, u16 P> struct is_promotable<double, std::complex<FP<BT, P> > >               : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };
template<typename BT, u16 P> struct is_promotable<FP<BT, P>, std::complex<double> >                : public is_promotable_ok { typedef std::complex<FP<BT, P> > result; };

#if defined(ARMA_USE_U128S128)
template<typename T> struct is_promotable<s128,    std::complex<T> > : public is_promotable_ok { typedef std::complex<T> result; };
template<typename T> struct is_promotable<u128,    std::complex<T> > : public is_promotable_ok { typedef std::complex<T> result; };
#endif
...
#if defined(ARMA_USE_U128S128)
template<> struct is_promotable<s128,    double> : public is_promotable_ok { typedef long double result; };
template<> struct is_promotable<u128,    double> : public is_promotable_ok { typedef long double result; };
#endif
#if defined(ARMA_USE_U64S64)
...
#if defined(ARMA_USE_U128S128)
template<> struct is_promotable<s128,    float> : public is_promotable_ok { typedef double result; };
template<> struct is_promotable<u128,    float> : public is_promotable_ok { typedef double result; };
#endif
#if defined(ARMA_USE_U64S64)
...
#if defined(ARMA_USE_U128S128)
template<> struct is_promotable<u32, u128> : public is_promotable_ok { typedef u128 result; };
template<> struct is_promotable<u16, u128> : public is_promotable_ok { typedef u128 result; };
template<> struct is_promotable<u8,  u128> : public is_promotable_ok { typedef u128 result; };
#endif
...
#if defined(ARMA_USE_U128S128)
#if defined(ARMA_USE_U64S64)
template<> struct is_promotable<u64, s128> : public is_promotable_ok { typedef s128 result; };
#endif
template<> struct is_promotable<s32, s128> : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<u32, s128> : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<s16, s128> : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<u16, s128> : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<s8 , s128> : public is_promotable_ok { typedef s128 result; };
template<> struct is_promotable<u8 , s128> : public is_promotable_ok { typedef s128 result; };
#endif
...
#if defined(ARMA_USE_U128S128)
template<typename BT, u16 P> struct is_promotable<s128, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<u128, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
#endif
#if defined(ARMA_USE_U64S64)
template<typename BT, u16 P> struct is_promotable<s64, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<u64, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
#endif
#if defined(ARMA_ALLOW_LONG)
template<typename BT, u16 P> struct is_promotable<slng_t, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<ulng_t, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
#endif
template<typename BT, u16 P> struct is_promotable<s32, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<u32, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<s16, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<u16, FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<s8,  FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
template<typename BT, u16 P> struct is_promotable<u8,  FP<BT, P> > : public is_promotable_ok { typedef FP<BT, P> result; };
